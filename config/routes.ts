...
export default [
  ...
  },
  {
    ...
    icon: 'workspace-icon.svg',
    component: './Admin',
    access: 'designer_workspace',
  },
  {
    path: '/designer/my-favourites',
    name: 'favourite',
    icon: 'my-favourite-icon.svg',
    component: './Admin',
    access: 'designer_my_favourite',
  },
  {
    ...
    icon: 'product-icon.svg',
    component: './Admin',
    access: 'designer_product',
    routes: [
      {
        path: '/designer/products/brand-products',
        name: 'brand.product',
        icon: 'brand-icon.svg',
        component: './Admin',
        access: 'designer_product_brand_product',
      },
      {
        path: '/designer/products/custom-library',
        name: 'custom.library',
        icon: 'design-firm-icon.svg',
        component: './Admin',
        access: 'designer_product_custom_library',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    icon: 'adminstration-icon.svg',
    component: './Admin',
    access: 'designer_administration',
    routes: [
      {
        path: '/designer/administration/office-profile',
        name: 'office.profile',
        icon: 'office-profile-icon.svg',
        component: './Admin',
        access: 'designer_administration_office_profile',
      },
      {
        path: '/desginer/administration/locations',
        name: 'location',
        icon: 'location-icon.svg',
        component: './Admin',
        access: 'designer_administration_location',
      },
      {
        path: '/desginer/administration/team-profiles',
        name: 'team.profile',
        icon: 'team-profile-icon.svg',
        component: './Admin',
        access: 'designer_administration_team_profile',
      },
      {
        path: '/desginer/administration/material-product-code',
        name: 'material/product.code',
        icon: 'material-product-code.svg',
        component: './Admin',
        access: 'designer_administration_material_product_code',
      },
    ],
  },
  // {
