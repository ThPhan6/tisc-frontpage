...
export default [
  ...
  },
  {
    ...
    routes: [
      {
        path: '/design/products/brand-products',
        name: 'brand.product',
        icon: 'brand-icon.svg',
        component: './Admin',
      ...
      {
        path: '/design/products/custom-library',
        name: 'custom.library',
        icon: 'design-firm-icon.svg',
        component: './Admin',
  ...
  },
  {
    ...
    routes: [
      {
        path: '/design/administration/office-profile',
        name: 'office.profile',
      ...
      {
        path: '/design/administration/locations',
        name: 'location',
        icon: 'location-icon.svg',
        component: './Admin',
      ...
      {
        path: '/design/administration/team-profiles',
        name: 'team.profile',
        icon: 'team-profile-icon.svg',
        component: './Admin',
      ...
      {
        path: '/design/administration/material-product-code',
