...
import { BasisPresetListResponse, SubBasisPreset } from '@/types';

import CustomTable, { GetExpandableTableConfig } from '@/components/Table';
import { ActionMenu } from '@/components/TableAction';

import styles from '../index.less';
import { PresetTabKey } from './PresetHeader';
...
const PresetTable: FC<PresetTableProps> = ({ type }) => {
  const tableRef = useRef<any>();

  const handleUpdatePreset = (id: string) => {
    pushTo(PATH.updatePresets.replace(':id', id) + `#${type}`);
  ...
  return (
    <CustomTable
      ...
      extraParams={{
        is_general: type === PresetTabKey.generalPresets,
      }}
