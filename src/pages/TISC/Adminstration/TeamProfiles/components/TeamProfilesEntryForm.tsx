...
export const TeamProfilesEntryForm: FC<TeamProfilesEntryFormValue> = (
  ...
  const handleOnChangePhoneNumber = (
    ...
    setEntryFormValue((prevEntryFormValue) => ({
      ...prevEntryFormValue,
  ...
  const handleRemovePhoneInputContent = (phoneInputKey: typePhoneInput) => {
    setEntryFormValue((prevEntryFormValue) => ({
      ...
      [phoneInputKey]: {
        zoneCode:
          phoneInputKey === 'phone'
            ? prevEntryFormValue.phone.zoneCode
            : prevEntryFormValue.mobile.zoneCode,
        phoneNumber: '',
      },
    }));
  };
  ...
  const handleRemoveInputContent = (inputKey: typeInput) => {
    setEntryFormValue((prevEntryFormValue) => ({ ...prevEntryFormValue, [inputKey]: '' }));
  };
  ...
  const handleSendInvite = () => {
    setEntryFormValue((prevEntryFormValue) => ({
      ...prevEntryFormValue,
      status: prevEntryFormValue.status ? false : true,
    }));
  };
