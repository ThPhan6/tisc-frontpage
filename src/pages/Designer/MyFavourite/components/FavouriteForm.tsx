...
import { retrieveFavouriteProduct, skipFavouriteProduct } from '@/services/design-favourite.api';

const FavouriteForm = () => {
  const [valueForm, setValueForm] = useState<RetrieveFavouriteProductRequestBody>({
    personal_email: '',
    phone_code: '',
    mobile: '',
  });
